...
const inputClass =
    "w-full rounded-xl border border-[#D9D6CF] bg-white text-[#111214] placeholder:text-[#6F706D] focus:border-[#C7A76C] focus:ring-1 focus:ring-[#C7A76C]/30";
                ...
                <form onSubmit={handleSubmit} className="mx-auto mt-10 max-w-5xl space-y-6 lg:mt-14">
                        ...
                        <Card.Content className="gap-7 px-5 py-7 sm:px-8">
                            ...
                            <div>
                                <div className="mb-4 flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
                                    ...
                                    <Button
                                        type="button" variant="outline" size="sm" onPress={addFeature} className="rounded-lg border-[#D9D6CF] bg-white text-[#111214] hover:border-[#C7A76C]"
                                    >
                                        <FiPlus />
                                        Add Feature
                                    </Button>
                    ...
                    <div className="flex flex-col items-stretch justify-between gap-4 rounded-2xl border border-[#D9D6CF] bg-[#151618] p-5 sm:flex-row sm:items-center sm:p-6">
                        ...
                        <Button
                            ...
                            size="lg"
                            variant="primary"
                            className="rounded-lg bg-[#C7A76C] px-7 font-semibold text-[#0B0B0C] hover:bg-[#AF8D52]"
                        >
                            Add Vehicle
                            <FiArrowRight />
                        </Button>
